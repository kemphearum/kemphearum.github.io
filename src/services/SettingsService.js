...
class SettingsService {
    ...
    static DEFAULT_TYPOGRAPHY_METADATA = {
        ...
        fontCategories: [
            ...
            { field: 'fontLogo', sizeField: 'fontLogoSize', weightField: 'fontLogoWeight', italicField: 'fontLogoItalic', label: 'Header Logo', hint: 'Main site logo text', icon: '🎨', defaultSize: '1.25rem', defaultWeight: '700' },
            { field: 'fontNav', sizeField: 'fontNavSize', weightField: 'fontNavWeight', italicField: 'fontNavItalic', label: 'Header Menu Bar', hint: 'Main navigation links', icon: '🧭', defaultSize: '0.85rem', defaultWeight: '600' },
            ...
            { field: 'fontFooterTitle', sizeField: 'fontFooterTitleSize', weightField: 'fontFooterTitleWeight', italicField: 'fontFooterTitleItalic', label: 'Footer Titles', hint: 'Site Mirrors header', icon: '📁', defaultSize: '0.65rem', defaultWeight: '600' },
            { field: 'fontFooterLink', sizeField: 'fontFooterLinkSize', weightField: 'fontFooterLinkWeight', italicField: 'fontFooterLinkItalic', label: 'Footer Links', hint: 'Mirror & social links', icon: '🔗', defaultSize: '0.68rem', defaultWeight: '400' },
            { field: 'fontFooterText', sizeField: 'fontFooterTextSize', weightField: 'fontFooterTextWeight', italicField: 'fontFooterTextItalic', label: 'Footer Text', hint: 'Copyright notice', icon: '⚖️', defaultSize: '0.7rem', defaultWeight: '400' },
            { field: 'fontFooterBrand', sizeField: 'fontFooterBrandSize', weightField: 'fontFooterBrandWeight', italicField: 'fontFooterBrandItalic', label: 'Footer Brand', hint: 'Footer logo/name text', icon: '📛', defaultSize: '1.25rem', defaultWeight: '700' },
            { field: 'fontFooterTagline', sizeField: 'fontFooterTaglineSize', weightField: 'fontFooterTaglineWeight', italicField: 'fontFooterTaglineItalic', label: 'Footer Tagline', hint: 'Footer subtitle text', icon: '📝', defaultSize: '0.8rem', defaultWeight: '400' },
            { field: 'fontAdminBrand', sizeField: 'fontAdminBrandSize', weightField: 'fontAdminBrandWeight', italicField: 'fontAdminBrandItalic', label: 'Admin Brand', hint: 'Admin logo text', icon: '👑', defaultSize: '1.25rem', defaultWeight: '700' },

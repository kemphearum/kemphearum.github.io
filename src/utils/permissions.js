...
export const MODULE_ACTIONS = {
    [MODULES.BLOG]: [ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE, ACTIONS.FEATURE, ACTIONS.TOGGLE_VISIBILITY],
    [MODULES.PROJECTS]: [ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE, ACTIONS.FEATURE, ACTIONS.TOGGLE_VISIBILITY],
    [MODULES.EXPERIENCE]: [ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE, ACTIONS.TOGGLE_VISIBILITY],
    [MODULES.USERS]: [ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.DATABASE]: [ACTIONS.DATABASE_ACTIONS],
    [MODULES.ANALYTICS]: [],
    [MODULES.SETTINGS]: [ACTIONS.EDIT],
    ...
    [MODULES.MESSAGES]: [ACTIONS.DELETE],

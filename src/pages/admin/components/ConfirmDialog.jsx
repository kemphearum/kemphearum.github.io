    ...
    return (
        <div className={styles.modalOverlay} onClick={() => setConfirmDialog({ isOpen: false, title: '', message: '', onConfirm: null, confirmText: 'Confirm', type: 'danger' })} style={{ zIndex: 1300 }}>
            <div className={styles.modalContent} onClick={e => e.stopPropagation()} style={{ maxWidth: '440px', padding: 0, borderRadius: '16px' }}>
                <div className={styles.modalHeader} style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', padding: '0.75rem 1.5rem', background: confirmDialog.type === 'danger' ? 'rgba(239, 68, 68, 0.05)' : 'rgba(251, 146, 60, 0.05)' }}>
                ...
                <div className={styles.modalFooter} style={{ padding: '0.75rem 1.5rem', display: 'flex', justifyContent: 'flex-end', gap: '0.75rem' }}>

        ...
        <div className="ui-analytics-filters">
            <div className="ui-preset-group">
                {[
                    ...
                    <button
                        key={p.value}
                        className={`ui-preset-btn ${range.preset === p.value ? 'active' : ''}`}
            ...
            <div className="ui-date-range-picker">
                ...
                />
                <span className="ui-date-separator">to</span>
                <input
                    type="date"
                    value={range.end}
            ...
            <div className="ui-filter-actions">
                ...
                {lastUpdated && (
                    <div className="ui-last-updated-container">
                        <span className="ui-last-updated-label">Updated:</span>
                        <span className="ui-last-updated-time">

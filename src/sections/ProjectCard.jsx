            ...
            <div className={styles.imageWrapper}>
                ...
                <div className={styles.imageOverlay}>
                    <div className={styles.overlayActions}>
                        {project.githubUrl && (
                            <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className={styles.overlayBtn} title={tr('View Source', 'មើលកូដប្រភព')}>
                        ...
                        {project.liveUrl && (
                            <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className={styles.overlayBtn} title={tr('Live Demo', 'សាកល្បងផ្ទាល់')}>
                ...
                <div className={styles.links}>
                    {project.slug && (
                        <Link
                            ...
                            aria-label={`${tr('View details for', 'មើលព័ត៌មានលម្អិតសម្រាប់')} ${title}`}
                        >

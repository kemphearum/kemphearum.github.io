            ...
            <div className={styles.imageWrapper}>
                ...
                <div className={styles.imageOverlay}>
                    <div className={styles.overlayActions}>
                        {project.githubUrl && (
                            <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className={styles.overlayBtn} title={t('ui.viewSource')}>
                        ...
                        {project.liveUrl && (
                            <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className={styles.overlayBtn} title={t('ui.liveDemo')}>
                ...
                <div className={styles.links}>
                    {project.slug && (
                        <Link
                            ...
                            aria-label={`${t('ui.viewDetailsFor')} ${title}`}
                        >
                            {t('ui.viewDetails1')}
                        </Link>
                    )}

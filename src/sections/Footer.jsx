            ...
            <div className={styles.container}>
                <div className={styles.topSection}>
                    <div className={styles.brand}>
                        ...
                        <p className={styles.tagline}>{settings.tagline || t('ui.iCTSecurityITAuditProfess')}</p>
                    </div>
                    ...
                    <div className={styles.socialLinks}>
                        <a href="https://github.com/kemphearum" target="_blank" rel="noopener noreferrer" className={styles.socialLink} title={t('ui.gitHub')}>
                        ...
                        <a href="mailto:kem.phearum@gmail.com" className={styles.socialLink} title={t('ui.email')}>
                ...
                <p className={styles.copyright}>{settings.footerText || t('ui.C2026KemPhearumAllRightsR')}</p>
            </div>
        </footer>
    );
};

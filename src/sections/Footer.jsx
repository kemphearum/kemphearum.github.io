            ...
            <div className={styles.container}>
                <div className={styles.topSection}>
                    ...
                    <div className={styles.socialLinks}>
                        <a href="https://github.com/kemphearum" target="_blank" rel="noopener noreferrer" className={styles.socialLink} title={tr('GitHub', 'GitHub')}>
                        ...
                        <a href="mailto:kem.phearum@gmail.com" className={styles.socialLink} title={tr('Email', 'អ៊ីមែល')}>

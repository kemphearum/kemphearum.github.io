                ...
                <div className={styles.topSection}>
                    ...
                    <div className={styles.socialLinks}>
                        {communication.github && (
                            <a href={communication.github} target="_blank" rel="noopener noreferrer" className={styles.socialLink} title={t('ui.gitHub')}>
                        ...
                        {communication.email && (
                            <a href={`mailto:${communication.email}`} className={styles.socialLink} title={t('ui.email')}>

...
const DATA = {
    ...
    content: [
        ...
        },
        {
            ...
            skills: ['ISO 27001', 'Risk Management', 'Security Audits', 'Zero Trust', 'SIEM', 'Cloud Security']
        },
        {
            id: 'profileInfo',
            ...
            industries: ['Banking & Finance', 'Government', 'Fintech'],
            accomplishments: [
                'Led ISO 27001 certification across 3 regional offices in 9 months',
                'Closed 18 major audit findings and matured security posture by 40%',
                'Architected zero-trust rollout for 5,000+ endpoints'
            ],
            oss: [
                'Maintainer of open-source security audit toolkit',
                'Contributor to OWASP top 10 guides'
            ],
            community: [
                'Mentor at local cybersecurity bootcamps',
                'Speaker at regional InfoSec conferences'
            ]
        },
        {
            id: 'contact',
